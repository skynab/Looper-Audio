...
> (feedback delay line, unit-tested). Deferred to validate live: audio recording, disk streaming.
> Next: more effects, sends/returns, automation. See the full roadmap in [`docs/PLAN.md`](docs/PLAN.md).
